...
describe MagicSeven do
  ...
  describe '#subtract_random_number' do
    context 'when previous value is 11 and random number is 4' do
      subject(:game2) { described_class.new(4) }
  ...
  describe '#play' do
    context 'when the random number is 18' do
      subject(:game3) { described_class.new(18) }
    ...
    context 'when the random number is 19' do
      subject(:game3) { described_class.new(19) }
    ...
    context 'when the random number is 20' do
      subject(:game3) { described_class.new(20) }
